...
WIZARD_SCENARIOS: list[dict] = [
    {
        ...
        "steps": [
            {
                "title": "准备文件",
                "detail": "把结构文件放进工作目录，或直接拖入窗口。",
                "hint": "支持 8 种结构格式（M-01 已扩展）。",
            },
            {"title": "拖放导入", "detail": "从资源管理器把文件拖进文件列表。", "hint": "可在配置里设扩展名白名单。"},
            {
                "title": "确认扫描",
                "detail": "确认文件出现在列表并带上了状态标记。",
    ...
    },
    {
        ...
        "steps": [
            {"title": "打开映射编辑器", "detail": "进入映射编辑界面。", "hint": "顶部有搜索框，可按英文/中文过滤。"},
            {
                "title": "填写中文名",
                "detail": "为每个英文名填中文名，或用模板/文件名建议。",
                "hint": "支持空白模板生成、从文件名反向建议（M-02/M-06）。",
            },
            {
                "title": "保存映射",
                "detail": "保存；保存前会提示拼写相近的重复项（M-03）。",
    ...
    },
    {
        ...
        "steps": [
            {"title": "预览", "detail": "先预览重命名计划，确认无误。", "hint": "预览里可取消个别项。"},
            {
                "title": "执行",
                "detail": "执行重命名，成功后映射表同步更新（D-02）。",
    ...
    },
    {
        ...
        "steps": [
            {"title": "选择分子", "detail": "选中一个结构文件。", "hint": "确认文件已正确命名/有映射。"},
            {
                "title": "打开 PSI4 对话框",
                "detail": "选择「单点能」任务与预设方法/基组。",
                "hint": "可用「快速（HF/STO-3G）」先跑通。",
            },
            {
                "title": "查看结果",
                "detail": "结果区显示能量与耗时；通俗结论区给出一句话解释（U-09）。",
    ...
    },
    {
        ...
        "steps": [
            {"title": "选任务", "detail": "PSI4 对话框选「几何优化」。", "hint": "先用 B3LYP/6-31G* 起步。"},
            {"title": "等待收敛", "detail": "观察日志；对话保持打开可取消（U-02）。", "hint": "结果含优化后坐标。"},
            {"title": "保存构象", "detail": "把优化结果导出为结构文件。", "hint": "可继续做频率/扫描。"},
        ],
    },
    {
        "id": "organize",
        ...
        "steps": [
            {"title": "按类型整理", "detail": "把结构/计算文件分目录归档。", "hint": "支持 dry-run 预览。"},
            {
                "title": "反向追溯",
                "detail": "查看某结构文件关联的 .log/.fchk（E-06）。",
                "hint": "动态元数据列可展示能量/方法等（E-01）。",
            },
            {
                "title": "导出/备份",
                "detail": "导出映射或打包项目（.molproj，E-05）。",
...
__all__ = ["WIZARD_SCENARIOS", "get_scenarios", "get_scenario", "total_steps", "scenario_ids"]
