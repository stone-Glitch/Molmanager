...
_GLOSSARY: dict[str, dict[str, str]] = {
    ...
    "SCF": {
        ...
        "cat": "量化术语",
        "desc": "迭代求解哈特里-福克/DFT 波函数，使场与密度自洽收敛。",
    },
    "HF": {
        "zh": "哈特里-福克",
        "en": "Hartree-Fock",
        "cat": "量化方法",
        "desc": "平均场近似的波函数方法，忽略电子相关；基准但不算相关能。",
    },
    "DFT": {
        "zh": "密度泛函理论",
        "en": "Density Functional Theory",
        "cat": "量化方法",
        "desc": "以电子密度为核心的量子化学方法，性价比高，含近似交换关联泛函。",
    },
    "B3LYP": {
        "zh": "B3LYP 泛函",
        "en": "B3LYP",
        "cat": "泛函",
        "desc": "最常用杂化泛函之一，含 HF 交换与梯度校正；有机分子几何/能量的稳妥默认。",
    },
    "basis set": {
        "zh": "基组",
        "en": "basis set",
        "cat": "量化术语",
        "desc": "用原子轨道线性组合逼近分子轨道的函数集；sto-3g 最小，def2/6-31G* 更精细。",
    },
    "sto-3g": {
        "zh": "STO-3G 基组",
        "en": "STO-3G",
        "cat": "基组",
        "desc": "最小基组，每个原子用一个收缩高斯函数；快速但不精确，适合试算/教学。",
    },
    "geometry optimization": {
        "zh": "几何优化",
        "en": "geometry optimization",
        "cat": "计算类型",
        "desc": "在给定方法/基组下寻找能量极小结构（键长/键角收敛）。",
    },
    "frequency": {
        "zh": "频率计算",
        "en": "frequency",
        "cat": "计算类型",
        "desc": "在优化结构上算振动频率；无虚频=稳定点，1 个虚频=过渡态。",
    },
    "TS": {
        "zh": "过渡态",
        "en": "transition state",
        "cat": "量化术语",
        "desc": "反应路径能量最高点，一阶鞍点，恰好一个虚频。",
    },
    "IRC": {
        "zh": "内禀反应坐标",
        "en": "Intrinsic Reaction Coordinate",
        "cat": "计算类型",
        "desc": "从过渡态沿最小能量路径向前/后追踪，验证反应前后真实连接的反应物/产物。",
    },
    "NMR": {
        "zh": "核磁共振",
        "en": "NMR",
        "cat": "波谱",
        "desc": "通过化学位移/shielding 预测谱图；需含 NMR 的泛函（如 mPW1PW91）与基组（如 6-31G*）。",
    },
    "pKa": {
        "zh": "酸解离常数",
        "en": "pKa",
        "cat": "物化性质",
        "desc": "衡量酸性；计算时需先确定质子化状态（见「去质子化」）。",
    },
    "logP": {
        "zh": "脂水分配系数",
        "en": "logP",
        "cat": "物化性质",
        "desc": "辛醇/水分配系数的对数，衡量亲脂性；越大越脂溶。",
    },
    "conformer": {
        "zh": "构象",
        "en": "conformer",
        "cat": "结构概念",
        "desc": "同 connectivity、不同单键二面角的空间排列；柔性分子有多个低能构象。",
    },
    "rotatable bond": {
        "zh": "可旋转键",
        "en": "rotatable bond",
        "cat": "结构概念",
        "desc": "单键中可自由旋转者（非环、非末端），越多构象空间越大。",
    },
    "solvent model": {
        "zh": "溶剂模型",
        "en": "solvent model",
        "cat": "量化术语",
        "desc": "隐式溶剂（如 PCM/IEFPCM）把溶剂当作连续介质，修正气相结果。",
    },
    "PCM": {
        "zh": "极化连续介质模型",
        "en": "PCM",
        "cat": "溶剂模型",
        "desc": "常用隐式溶剂；若溶剂不可用会回退气相并给出醒目告警（科学红线 S-04）。",
    },
    "basis convergence": {
        "zh": "基组收敛",
        "en": "basis convergence",
        "cat": "量化术语",
        "desc": "结果随基组增大趋于极限；triple-zeta 通常已较可靠。",
    },
    "zero-point energy": {
        "zh": "零点能",
        "en": "Zero-Point Energy (ZPE)",
        "cat": "热化学",
        "desc": "频率计算给出的 0K 振动能修正；热化学量需含此项。",
    },
    ...
    "Gibbs free energy": {
        ...
        "cat": "热化学",
        "desc": "G = H - TS；判断反应自发性与平衡常数的关键量。",
    },
    "BSSE": {
        "zh": "基组叠加误差",
        "en": "Basis Set Superposition Error",
        "cat": "量化术语",
        "desc": "弱相互作用计算时因基组重叠被高估结合能；用 Counterpoise 校正。",
    },
    "dispersion": {
        "zh": "色散校正",
        "en": "dispersion (D3/D4)",
        "cat": "泛函",
        "desc": "范德华/长程吸引修正；无校正泛函（如 B3LYP）对弱作用偏差大，加 -D3。",
    },
    "optimization": {
        "zh": "优化",
        "en": "optimization",
        "cat": "计算类型",
        "desc": "见 geometry optimization；收敛失败常因初始结构差或对称性。",
    },
    "spin multiplicity": {
        "zh": "自旋多重度",
        "en": "spin multiplicity",
        "cat": "量化术语",
        "desc": "2S+1；闭壳层=1，自由基=2；设错会导致收敛怪异或能量虚高。",
    },
    "charge": {
        "zh": "电荷",
        "en": "charge",
        "cat": "量化术语",
        "desc": "分子总电荷；与多重度共同决定电子数，务必与真实体系一致。",
    },
}
...
def lookup_term(
    term: str, max_dist: int = 1, _glossary: dict[str, dict[str, str]] | None = None
) -> dict[str, str] | None:
    """
...
def glossary_search(keyword: str, _glossary: dict[str, dict[str, str]] | None = None) -> list[dict[str, str]]:
...
def make_glossary_tooltip(widget, term: str | None = None, resolve_term=None) -> None:
    """
