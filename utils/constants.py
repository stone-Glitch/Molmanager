...
RUN_PRESETS: dict[str, dict[str, Any]] = {
    "快速（力场，不走 PSI4，仅 OpenBabel 优化）": {
        "task_type": "_ff_optimize",
        "method": DEFAULT_FORCEFIELD,
        "basis": "",
        "preset_name": "快速（力场）",
        "solvent": None,
        "d3": False,
    ...
    "高精度（M062X/def2-TZVP + D3）": {
        ...
        "method": "m062x",
        "basis": "def2-tzvp",
        "preset_name": "高精度（M062X/def2-TZVP+D3）",
        "solvent": None,
        "d3": True,
        "memory_gb": 8,
    },
    "高精度单点（DLPNO-CCSD(T)/cc-pVTZ）": {
        ...
        "method": "ccsd(t)",
        "basis": "cc-pvtz",
        "preset_name": "高精度单点（CCSD(T)/cc-pVTZ）",
        "solvent": None,
        "d3": False,
        "memory_gb": 16,
    },
    "溶剂化水相（SMD-water/B3LYP/6-31G*）": {
        ...
        "method": "b3lyp",
        "basis": "6-31g*",
        "preset_name": "水溶液（SMD/B3LYP/6-31G*）",
